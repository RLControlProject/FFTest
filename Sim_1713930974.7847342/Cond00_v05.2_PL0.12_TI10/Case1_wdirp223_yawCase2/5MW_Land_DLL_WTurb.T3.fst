...
---------------------- INPUT FILES ---------------------------------------------
"./NRELOffshrBsline5MW_Onshore_ElastoDyn.T3_mod.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"/projects/rlfarmcontr/RLControl_Parallel/RLControl/windfarm_v1p0/FFSetup/Template_5MW/5MW_Land_DLL_WTurb/NRELOffshrBsline5MW_Onshore_AeroDyn15.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
"./NRELOffshrBsline5MW_Onshore_ServoDyn.T3_mod.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
